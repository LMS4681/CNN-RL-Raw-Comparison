...
[![Open improved CNN in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/LMS4681/CNN-RL-Raw-Comparison/blob/scale-aware-cnn-6h-v5/notebooks/improved_cnn_6h.ipynb)
...
`scale-aware-cnn-6h-v5` notebook supplies the immutable baseline, scenario,
...
through V4 tags remain immutable.
